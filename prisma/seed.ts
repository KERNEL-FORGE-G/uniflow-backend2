...
async function main() {
  ...
  await Promise.all([
    prisma.subscriptionPlan.upsert({
      where: { code: 'pass-etudiant' },
      update: {
        name: 'Pass Étudiant',
        category: 'PERSONAL',
        description: "Gestion personnelle des cours, devoirs, notes et emploi du temps.",
        priceMonthlyXaf: 100,
        priceAnnuallyXaf: 1000,
        priceMonthlyEur: 1,
        priceAnnuallyEur: 10,
        period: 'Facturé selon le cycle choisi',
        features: ['Cours et notes personnels', 'Emploi du temps modifiable', 'Devoirs et rappels'],
        providers: ['MTN_MOMO', 'ORANGE_MONEY', 'NOTCHPAY', 'CINETPAY', 'STRIPE', 'CARD'],
    ...
    prisma.subscriptionPlan.upsert({
      where: { code: 'enseignant-pro' },
      update: {
        name: 'Pack Enseignant Pro',
        category: 'TEACHER',
        description: 'Outils personnels pour enseignants indépendants et vacataires.',
        priceMonthlyXaf: 500,
        priceAnnuallyXaf: 5000,
        priceMonthlyEur: 3,
        priceAnnuallyEur: 30,
        period: 'Facturé selon le cycle choisi',
        features: ['Cours et créneaux personnels', 'Suivi des devoirs', 'Gestion des évaluations'],
        providers: ['MTN_MOMO', 'ORANGE_MONEY', 'NOTCHPAY', 'CINETPAY', 'STRIPE', 'CARD'],
